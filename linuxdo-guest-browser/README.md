...
| PyCharm | `0.14.1` | [下载 ZIP](https://github.com/Leisure-Xr/chas/raw/main/linuxdo-guest-browser/dist/linuxdo-guest-browser-pycharm-0.14.1.zip) | `linuxdo-guest-browser-pycharm-0.14.1.zip` | `43b8cdc911ac8259f11b278e2f667c191451ff23de263d74999262d63cadf979` |
...
PyCharm 版使用内嵌 JCEF 浏览器，默认采用自适应的单色隐私阅读布局，可从“…”菜单切回原始网页。`0.14.1` 修复 PyCharm 2024.2 等旧版 IDE 中游客会话初始化任务不执行而永久白屏的问题，并为加载失败和超时增加可重试错误页。隐私阅读页、加载背景、休息提醒和小游戏采用当前 PyCharm 的背景、文字、边框与强调色；小字号次要文字会在保留主题色调的同时确保至少 `4.5:1` 对比度。
