...
| PyCharm | `0.14.2` | [下载 ZIP](https://github.com/Leisure-Xr/chas/raw/main/linuxdo-guest-browser/dist/linuxdo-guest-browser-pycharm-0.14.2.zip) | `linuxdo-guest-browser-pycharm-0.14.2.zip` | `0c12774a92afd79db1fabc64baa0c8fc3416848905a32b454848afbbe965b2d7` |
...
PyCharm 版使用内嵌 JCEF 浏览器，默认采用自适应的单色隐私阅读布局，可从“…”菜单切回原始网页。`0.14.2` 修复首次导航依赖已错过的 `about:blank` 回调而永久白屏的问题，并确保导航请求发出前就启动可重试超时保护。隐私阅读页、加载背景、休息提醒和小游戏采用当前 PyCharm 的背景、文字、边框与强调色；小字号次要文字会在保留主题色调的同时确保至少 `4.5:1` 对比度。
